...
**Engagement:** Independent research — self-directed, not commissioned by a client.
...
The harness is good at catching internal contradictions and stale citations. It's not good at catching a source that was simply wrong everywhere, consistently — that's a job for a wider adversarial round, not a smarter test.
